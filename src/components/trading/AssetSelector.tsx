...
import { Search, Filter, Star, TrendingUp, Volume2 } from 'lucide-react';
...
export const AssetSelector: React.FC<AssetSelectorProps> = ({
  ...
  ), [searchFilters.type, searchFilters.showOnlyFavorites, handleFilterChange]);
  ...
  ), [searchFilters.sortBy, searchFilters.sortOrder, handleFilterChange]);
      ...
      <div className="border-t pt-4 space-y-3">
        <div className="flex items-center justify-between">
          ...
          <input
            ...
            className="w-24 px-2 py-1 text-sm border rounded focus:outline-none focus:ring-2 focus:ring-ring"
            placeholder="0"
          />
        </div>
      </div>
    );
  }, [showAdvancedFilters, searchFilters.minVolume, handleFilterChange]);
  ...
  return (
    <div className={cn("bg-card border rounded-lg overflow-hidden", className)}>
      ...
      <div className="p-4 border-b space-y-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            placeholder="Search assets (e.g. BTC, Bitcoin, Ethereum...)"
            className={cn(
      ...
      {/* Results */}
      <div className={cn("relative", compact ? "max-h-96" : "max-h-[600px]")}>
        <AssetList
